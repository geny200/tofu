...
object ConfigMonad {
  ...
  def fromMonadAndErrors[F[_]](implicit
      F: Monad[F],
  ...
  object promote {
    ...
    implicit def localByConfig[F[_]](implicit F: ConfigMonad[F]): WithLocal[F, Path] = F.path
...
object ConfigTContext {
  ...
  implicit def configTParallelConfigMonad[F[_]: ParallelReader](implicit
      F: Monad[F],
