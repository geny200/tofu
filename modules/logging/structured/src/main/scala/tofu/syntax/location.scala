...
object location {
  object logging {
    ...
    implicit final class LoggingInterpolator(private val sctx: StringContext) extends AnyVal {
      def error[F[_]](values: LoggedValue*)(implicit logging: Logging[F], location: Location): F[Unit] =
        logging.error(sctx.s(braces(values.size): _*), (values :+ location.loggedValue): _*)
      def warn[F[_]](values: LoggedValue*)(implicit logging: Logging[F], location: Location): F[Unit]  =
        logging.warn(sctx.s(braces(values.size): _*), (values :+ location.loggedValue): _*)
      def info[F[_]](values: LoggedValue*)(implicit logging: Logging[F], location: Location): F[Unit]  =
        logging.info(sctx.s(braces(values.size): _*), (values :+ location.loggedValue): _*)
      def debug[F[_]](values: LoggedValue*)(implicit logging: Logging[F], location: Location): F[Unit] =
        logging.debug(sctx.s(braces(values.size): _*), (values :+ location.loggedValue): _*)
      def trace[F[_]](values: LoggedValue*)(implicit logging: Logging[F], location: Location): F[Unit] =
      ...
      )(implicit logging: Logging[F], location: Location): F[Unit] =
    ...
    implicit final class LoggingCauseOps(private val message: String) extends AnyVal {
      def cause[F[_]](ex: Throwable)(implicit logging: Logging[F], location: Location): F[Unit] =
